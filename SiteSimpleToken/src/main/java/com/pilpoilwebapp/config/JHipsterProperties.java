...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pilpoilweb@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pilpoilweb API";

        private String description = "pilpoilweb API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pilpoilweb";
