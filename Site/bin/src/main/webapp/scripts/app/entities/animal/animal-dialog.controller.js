...
angular.module('pilPoilApp').controller('AnimalDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Animal', 'Ad', 'AnimalType', 'Breed', 'User',
        function($scope, $stateParams, $uibModalInstance, entity, Animal, Ad, AnimalType, Breed, User) {
