...
import com.pilpoil.repository.AuthorityRepository;
import com.pilpoil.repository.UserRepository;
import com.pilpoil.security.AuthoritiesConstants;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        UserDTO dup = new UserDTO(u.getLogin(), u.getPassword(), u.getLogin(), u.getLastName(),
            "alicejr@example.com", true, u.getLangKey(), u.getPhone(), u.getDistance(), u.getAuthorities());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        UserDTO dup = new UserDTO("johnjr", u.getPassword(), u.getLogin(), u.getLastName(),
            u.getEmail(), true, u.getLangKey(), u.getPhone(), u.getDistance(), u.getAuthorities());
