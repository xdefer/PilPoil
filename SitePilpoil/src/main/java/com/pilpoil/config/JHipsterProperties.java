...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pilpoil@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pilpoil API";

        private String description = "pilpoil API documentation";
